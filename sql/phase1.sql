...
CREATE TABLE gl19 AS 
SELECT * FROM gl_phase1 
WHERE 
...
CREATE TABLE gl_phase1_sans19 AS 
SELECT a.* FROM 
  gl_phase1 AS a 
  LEFT OUTER JOIN 
  gl19 AS b 
...
CREATE TABLE gl29 AS 
SELECT * FROM gl_phase1_sans19 
WHERE 
...
CREATE TABLE gl_phase1_sans19_29 AS 
SELECT a.* FROM 
  gl_phase1_sans19 AS a 
  LEFT OUTER JOIN 
  gl29 AS b 
  ON a.desig = b.desig
WHERE b.desig is null;
...
CREATE TABLE gl9 AS 
SELECT * FROM gl_phase1_sans19_29 
WHERE 
...
CREATE TABLE gl_phase1_sans19_29_9 AS
SELECT a.* FROM 
  gl_phase1_sans19_29 AS a
  LEFT OUTER JOIN 
  gl9 AS b  
  ON a.desig = b.desig 
WHERE b.desig is null;
...
CREATE TABLE gl20 AS
SELECT * FROM gl_phase1_sans19_29_9 
WHERE
...
CREATE TABLE gl_phase1_sans19_29_9_20 AS 
SELECT a.* FROM 
...
--EXTRACT CLASSI
CREATE TABLE gl1 AS SELECT * FROM gl_phase1_sans19_29_9_20
WHERE 
  c45_58 > 0.7 AND 
  c36_45 > 0.7;

--ELIMINATE CLASSI
CREATE TABLE gl_phase1_sans19_29_9_20_1 AS 
SELECT a.* FROM
  gl_phase1_sans19_29_9_20 AS a
  LEFT OUTER JOIN
  gl1 AS b
  ON a.desig = b.desig
WHERE b.desig IS NULL;
...
--EXTRACT CLASSII
CREATE TABLE gl2 AS SELECT * FROM gl_phase1_sans19_29_9_20_1 
WHERE
  c45_80 - SQRT(SQUARE(dm4_5)+SQUARE(dm8_0)) > 0.5 AND
  c36_58 - SQRT(SQUARE(dm3_6)+SQUARE(dm5_8)) > 0.35 AND 
